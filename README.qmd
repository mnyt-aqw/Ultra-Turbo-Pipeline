...
::: {.callout-note}
When ypu specify paths to files you can either use full paths. Or you can use relative paths. But instead us specifying ``"../../db/*.gz"``. You do it like this ``"${projectDir}/../../db/*.gz"``. If you do that do **not** use single quotes `'`, use doable `"`. 
:::
